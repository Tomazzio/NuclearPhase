# NuclearPhase [![CI Status](https://github.com/Pl3aseJust3ndMySuffering/NuclearPhase/workflows/Run%20Tests/badge.svg)](https://github.com/Pl3aseJust3ndMySuffering/NuclearPhase/actions)
...
The code for NuclearPhase is licensed under the [GNU Affero General Public License v3](https://www.gnu.org/licenses/agpl.html), which can be found in full in [/LICENSE](/LICENSE).
